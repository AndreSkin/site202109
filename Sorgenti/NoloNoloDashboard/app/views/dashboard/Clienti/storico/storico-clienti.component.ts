...
@Component({
  ...
  templateUrl: './storico-clienti.component.html',
  styleUrls: ['./storico-clienti.component.scss']
})

@Injectable()
export class StoricoClientiComponent implements OnInit{
